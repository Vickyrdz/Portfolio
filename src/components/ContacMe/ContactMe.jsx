    ...
    return (
        <motion.div initial={{ opacity: 0, y: 50, }}
            ...
            <div className=" flex flex-row text-3xl">
                ...
                <Divider className="w-[49rem] bg-white ml-[2rem] mb-5 mt-5"/>
            </div>
            <div className="mt-12">
                    <form  className="flex flex-col gap-3" target="_blank" action="https://formsubmit.co/vickyrodriguez544@gmail.com" method="POST">
                        <div >
                            <div className="flex flex-row gap-3 justify-center">
                                <div>
                                    <input className="bg-strongGray p-3 focus:outline-none active:outline-none rounded-2xl w-[15rem]" 
                        ...
                        <div >
                            <textarea className="bg-strongGray p-3 focus:outline-none active:outline-none rounded-2xl h-[10.938rem] w-[31.25rem]" 
                        ...
                        <div className="flex self-center  ">
                            <button className={`bg-pink p-3 rounded-2xl w-[10.5rem] font-bold  ${
