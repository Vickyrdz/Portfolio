                    ...
                    <form  className="flex flex-col gap-3" target="_blank" action="https://formsubmit.co/vickyrodriguez544@gmail.com" method="POST">
                        <div >
                            <div className="flex flex-col sm:flex-row gap-3 justify-center">
                                <div>
                                    <input className="bg-strongGray w-60 text-xs p-3 focus:outline-none active:outline-none rounded-2xl sm:w-[11.75rem] lg:w-[15rem]" 
                        ...
                        <div >
                            <textarea className="bg-strongGray p-3 h-32 w-60 focus:outline-none active:outline-none rounded-2xl sm:w-96 lg:h-[10.938rem] lg:w-[31.25rem]" 
